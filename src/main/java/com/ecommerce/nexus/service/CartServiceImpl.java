...
import com.ecommerce.nexus.repositories.CartItemRepository;
...
public class CartServiceImpl implements CartService {
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        // CartItem cartItem = cartItemRepository.findCartItemByCartAndProduct(cart,
        // product);
        ...
        if (quantity > product.getQuantity()) {
            throw new APIException("Only " + product.getQuantity() + " " + product.getProductName()
                    + " left");
        }
    ...
    private Cart createOrRetrieveCart() {
        Cart userCart = cartRepository.findCartByUser(authUtil.loggedInUser());
        if (userCart != null) {
            return userCart;
        }
